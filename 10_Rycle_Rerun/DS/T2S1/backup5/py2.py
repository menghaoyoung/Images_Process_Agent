...
def main():
    parser = argparse.ArgumentParser(description='Process image line grayscale values.')
    parser.add_argument('-resolution', type=float, default=1.08, help='Resolution value (default: 1.08)')
    ...
    print(f"Real length: {real_length:.2f} units")
