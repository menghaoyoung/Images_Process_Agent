...
def main():
    ...
    real_length = pixel_dist * args.resolution
    print(f"Calculated segment length: {real_length:.2f} units")
    
    # Generate CSV filename with resolution
    csv_filename = f"line_gray_values_res_{args.resolution:.2f}.csv"
