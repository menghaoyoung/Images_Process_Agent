...
def parse_resolution_arg():
    """Custom parser for -resolution=value argument"""
    resolution = None
...
def main():
    # Parse resolution argument manually
    resolution = parse_resolution_arg()
    if resolution is None:
        print("Error: Missing or invalid -resolution argument")
        print("Usage: python py1.py -resolution=<value>")
        sys.exit(1)
