...
def main():
    ...
    # Calculate and print first derivative (difference between consecutive grayscale values)
    ...
    plt.plot(derivative, marker='o', linestyle='-', color='red')
    plt.title("First Derivative of Grayscale Values Along Line")
    plt.xlabel("Index Along Line (n -> n+1)")
    plt.ylabel("Grayscale Difference")
    plt.grid(True)
    plt.tight_layout()
    plt.show()
