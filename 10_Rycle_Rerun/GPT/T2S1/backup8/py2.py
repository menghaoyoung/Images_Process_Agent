...
def main():
    ...
    parser.add_argument('-image_dir', type=str, required=True, help='Input image path')
    parser.add_argument('-output_dir', type=str, required=True, help='Directory for CSV output')
    parser.add_argument('-start', type=str, required=True, help='Start point as x,y')
    parser.add_argument('-end', type=str, required=True, help='End point as x,y')
