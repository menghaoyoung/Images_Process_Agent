...
def get_line_grayscale(csv_path):
    """
    Reads grayscale values from a CSV file.
    Returns a numpy array of grayscale values.
    """
    gray_values = []
...
def main():
    # Parameters matching those from prior steps
    ...
    plt.plot(gray_values, marker='o', linestyle='-', color='b')
    plt.title(f"Grayscale Values Along Line {start_point} to {end_point}")
