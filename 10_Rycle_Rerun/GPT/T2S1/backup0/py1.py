...
# Core function: Calculate μ_eq (length of line in mm)
...
def main():
    ...
    parser.add_argument('-output_dir', type=str, default=r'C:\Users\admin\Desktop\Python_proj\ALL_RESULT\GPT\T2S1\backup', help="Where to store CSV")
    ...
    image = Image.open(image_path).convert('L')  # 'L' mode is (8-bit pixels, black and white)
