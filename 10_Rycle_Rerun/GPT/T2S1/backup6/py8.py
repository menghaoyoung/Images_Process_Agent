...
mu_eq_plot_path = os.path.join(output_dir, f'mu_eq_curve_res{resolution}.png')
...
def plot_μeq_curve():
    ...
    plt.grid(True)
    plt.tight_layout()
    plt.savefig(mu_eq_plot_path, dpi=150)
    print(f"μ_eq curve plot saved to: {mu_eq_plot_path}")
    plt.show()
