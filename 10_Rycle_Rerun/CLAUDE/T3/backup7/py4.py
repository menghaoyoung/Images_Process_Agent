...
def process_images(input_directory):
    ...
    for image_file in image_files:
        ...
        process_enhanced_image(enhanced_path, csv_path, highlight_path)

def process_enhanced_image(enhanced_image_path, csv_path, highlight_path):
    """
    ...
    print(f"Saved highlight image to: {highlight_path}")
