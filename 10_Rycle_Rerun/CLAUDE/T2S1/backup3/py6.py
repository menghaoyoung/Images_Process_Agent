# process_image.py - Process image and extract grayscale values along a line
import os
import numpy as np
...
def process_and_save(resolution=1.08):
    """
    Process the image with the given resolution and save results to CSV.
    """
    # Define parameters
...
if __name__ == "__main__":
    # If run directly, process with default resolution
    process_and_save()
